        ...
        eval(
          "AlterAssoc" +
            ...
            feature.name +
             ...
             "= grafo.model.insertEdge(grafo.model.getDefaultParent(), null, '', associ[0], associ[associ.length-1],'edgeStyle=roundedStyle;curved=1;strokeColor=red; stroke-width=15')"
          );
        eval(
          "AlterAssoc" +
            feature.parent[0].value +
